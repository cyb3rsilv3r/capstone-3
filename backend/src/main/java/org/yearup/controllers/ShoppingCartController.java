...
public class ShoppingCartController {
    ...
    public ShoppingCart deleteCart(Principal principal) {
        String userName = principal.getName();// to grab the username
        User user = userService.getByUserName(userName);//to grab who is actually using the database
        int userId = user.getId();//obvious enough
